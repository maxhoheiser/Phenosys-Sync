...
output_name_3(2,1:12)=["trial-num","time","time-corr","behavior","time_in_ground_truth","trial-num","time","time-corr","behavior","time_in_ground_truth","diff time excel - ttl", "behavior diff excel - ttl"];
