...
output_file_ground_truth = [output_name; ground_truth_trial];
filename = 'output_file.xlsx';
...
output_name_3(2,1:10)=["trial-num","time","time-corr","behavior","time_in_ground_truth","trial-num","time","time-corr","behavior","time_in_ground_truth"];
